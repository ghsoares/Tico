...
exports.getType = exports.unescapeString = exports.fromHex = exports.colorfy = exports.backgroundReset = exports.background = exports.foregroundReset = exports.foreground = exports.treefy = void 0;
const BRANCH_STR = [
    "└──",
    "├──",
    "│",
];
function treefy(tree, options = {}) {
...
function foregroundReset() {
    return `\x1b[37m`;
}
exports.foregroundReset = foregroundReset;
...
exports.backgroundReset = backgroundReset;
function colorfy(str, fg, bg = null) {
    let ss = "";
    ss += foreground(fg);
    if (bg) {
        ss += background(bg);
